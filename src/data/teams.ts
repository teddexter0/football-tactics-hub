...
export const legendaryTeams: Team[] = [
...

  {
    ...
    achievement: "World Cup Winners - Perfect Balance Around Genius",
    formation: "4-3-2-1 Christmas Tree",
    style: "Balanced Pragmatism, Creative Freedom for Zidane, Set Piece Mastery",
    description: "Jacquet's tactical masterpiece built around Zinedine Zidane. Three defensive midfielders protected Zizou's genius while maintaining perfect balance between defense and attack.",
    primaryColor: "#0055A4",
    secondaryColor: "#EF4135",
    quote: "Jacquet saw a weakness defending set pieces from Brazil. He told Zizou to go at the near post.",
    managerImage: getManagerImage("Aime Jacquet", "#0055A4"),
    phases: {
      0: {
        players: [
          { id: 16, name: "Barthez", position: "GK", x: 50, y: 95, role: "Eccentric Keeper", detail: "Unique character who brought calmness to defense" },
          { id: 15, name: "Thuram", position: "RB", x: 15, y: 75, role: "Attacking FB", detail: "Legendary fullback who could score crucial goals" },
          { id: 8, name: "Desailly", position: "CB", x: 40, y: 80, role: "Defensive Leader", detail: "The rock - leadership and defensive mastery" },
          { id: 5, name: "Blanc", position: "CB", x: 60, y: 80, role: "Elegant CB", detail: "Ball-playing defender with composure" },
          { id: 3, name: "Lizarazu", position: "LB", x: 85, y: 75, role: "Balanced FB", detail: "Solid defender who supported attacks when needed" },
          { id: 7, name: "Deschamps", position: "CDM", x: 50, y: 65, role: "Water Carrier", detail: "The leader who did the dirty work for stars" },
          { id: 17, name: "Petit", position: "CM", x: 35, y: 60, role: "Defensive Mid", detail: "Arsenal warrior who protected the defense" },
          { id: 4, name: "Karembeu", position: "CM", x: 65, y: 60, role: "Energetic Mid", detail: "Covered ground and provided physicality" },
          { id: 10, name: "Zidane", position: "CAM", x: 45, y: 45, role: "Maestro", detail: "The genius given complete freedom to create" },
          { id: 22, name: "Djorkaeff", position: "SS", x: 55, y: 45, role: "Trequartista", detail: "Creative support for Zidane's brilliance" },
          { id: 20, name: "Guivarc'h", position: "ST", x: 50, y: 25, role: "Target Man", detail: "Created space for others without scoring" }
        ]
      },
      1: {
        players: [
          { id: 16, name: "Barthez", position: "GK", x: 50, y: 88, role: "Quick Distribution", detail: "Fast throws to start counter-attacks" },
          { id: 15, name: "Thuram", position: "RB", x: 12, y: 65, role: "Overlapping FB", detail: "Provides width when needed" },
          { id: 8, name: "Desailly", position: "CB", x: 40, y: 78, role: "Organizing CB", detail: "Commands defense with authority" },
          { id: 5, name: "Blanc", position: "CB", x: 60, y: 78, role: "Playing CB", detail: "Starts attacks from deep with precision" },
          { id: 3, name: "Lizarazu", position: "LB", x: 88, y: 65, role: "Supporting FB", detail: "Balanced approach to attacking" },
          { id: 7, name: "Deschamps", position: "CDM", x: 50, y: 70, role: "Deep Anchor", detail: "Protective shield for creative players" },
          { id: 17, name: "Petit", position: "CM", x: 30, y: 60, role: "Supporting Mid", detail: "Provides platform for Zidane magic" },
          { id: 4, name: "Karembeu", position: "CM", x: 70, y: 60, role: "Work Rate Mid", detail: "Covers ground to free Zidane" },
          { id: 10, name: "Zidane", position: "CAM", x: 40, y: 35, role: "Free Role", detail: "Complete freedom to orchestrate attacks" },
          { id: 22, name: "Djorkaeff", position: "SS", x: 60, y: 35, role: "Creative Support", detail: "Links play between midfield and attack" },
          { id: 20, name: "Guivarc'h", position: "ST", x: 50, y: 20, role: "Space Creator", detail: "Selfless striker who creates for others" }
        ],
        movements: [
          { from: { x: 45, y: 45 }, to: { x: 40, y: 35 }, type: 'movement', player: 'Zidane Free Role', color: '#0055A4' },
          { from: { x: 15, y: 75 }, to: { x: 12, y: 65 }, type: 'movement', player: 'Thuram Overlaps', color: '#EF4135' }
        ],
        zones: [
          { x: 25, y: 25, width: 50, height: 35, color: 'rgba(0, 85, 164, 0.3)', label: 'Zidane Creative Zone - Complete Freedom' }
        ]
      },
      2: {
        players: [
          { id: 16, name: "Barthez", position: "GK", x: 50, y: 88, role: "Commanding GK", detail: "Organizes defense with vocal leadership" },
          { id: 15, name: "Thuram", position: "RB", x: 20, y: 70, role: "Defensive RB", detail: "Solid defensive work without compromise" },
          { id: 8, name: "Desailly", position: "CB", x: 40, y: 75, role: "Warrior CB", detail: "Wins every battle with determination" },
          { id: 5, name: "Blanc", position: "CB", x: 60, y: 75, role: "Composed CB", detail: "Calm under pressure, never panics" },
          { id: 3, name: "Lizarazu", position: "LB", x: 80, y: 70, role: "Disciplined LB", detail: "Maintains shape with French precision" },
          { id: 7, name: "Deschamps", position: "CDM", x: 45, y: 65, role: "Destroyer", detail: "Breaks up play with intelligent reading" },
          { id: 17, name: "Petit", position: "CDM", x: 55, y: 65, role: "Physical Mid", detail: "Uses strength to dominate midfield" },
          { id: 4, name: "Karembeu", position: "CM", x: 35, y: 55, role: "Covering Mid", detail: "Provides defensive cover across midfield" },
          { id: 10, name: "Zidane", position: "CM", x: 65, y: 55, role: "Defensive Zidane", detail: "Even the genius tracked back when needed" },
          { id: 22, name: "Djorkaeff", position: "CAM", x: 50, y: 45, role: "Pressing 10", detail: "Creative player who also pressed" },
          { id: 20, name: "Guivarc'h", position: "ST", x: 50, y: 35, role: "Isolated Forward", detail: "Holds up play ready for counter" }
        ],
        zones: [
          { x: 0, y: 45, width: 100, height: 40, color: 'rgba(239, 65, 53, 0.2)', label: 'Collective Defensive Discipline' }
        ]
      },
      3: {
        corners: [
          {
            name: "Zidane Header Magic",
            players: [
              { id: 10, name: "Zidane", position: "CAM", x: 88, y: 82, role: "Near Post Genius", detail: "Two headers in World Cup final" },
              { id: 8, name: "Desailly", position: "CB", x: 78, y: 78, role: "Physical Presence", detail: "Dominant in air at set pieces" },
              { id: 5, name: "Blanc", position: "CB", x: 82, y: 75, role: "Tall Target", detail: "Uses height effectively" },
              { id: 17, name: "Petit", position: "CM", x: 95, y: 85, role: "Corner Specialist", detail: "Perfect delivery from wide areas" }
            ],
            opposition: [
              { x: 50, y: 90, role: "GK" }, { x: 85, y: 85, role: "Defender" }
            ]
